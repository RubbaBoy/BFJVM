...
//        pushBytes(0x07, 0x0, 0x02);
        ...
        // HelloWorld
//        pushBytes(/* UTF8 */ 0x01, /* Size, 10 bytes */ 0x0, 0x0a);
//        pushBytes(0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x57, 0x6f, 0x72, 0x6c, 0x64);

        // java/lang/Object
//        pushBytes(/* Class */ 0x07, /* 4 */ 0x0, 0x04);
//        pushBytes(/* UTF8 */ 0x01, /* Length, 16 */ 0x0, 0x10,   0x6a, 0x61, 0x76, 0x61, 0x2f, 0x6c, 0x61, 0x6e, 0x67, 0x2f, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74);

        // java/lang/System
//        pushBytes(/* Class */ 0x07, 0x0, /* 6 */ 0x06);
//        pushBytes(/* UTF8 */ 0x01, 0x0, 0x10,   0x6a, 0x61, 0x76, 0x61, 0x2f, 0x6c, 0x61, 0x6e, 0x67, 0x2f, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d);

        // java/io/PrintStream
//        pushBytes(/* Class */ 0x07, 0x0, /* 8 */ 0x08);
//        pushBytes(/* UTF8 */ 0x1, 0x0, 0x13,   0x6a, 0x61, 0x76, 0x61, 0x2f, 0x69, 0x6f, 0x2f, 0x50, 0x72, 0x69, 0x6e, 0x74, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d);

        // "Hello World"
//        pushBytes(/* String constant */ 0x8, 0x0, /* the index of the UTF8 data of string */ 0x0a);
//        pushBytes(/* UTF8 */ 0x1, 0x0, 0xb,   0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x20, 0x57, 0x6f, 0x72, 0x6c, 0x64);
